                        ...
                        <div class="d-flex">
                            <div class="dropdown mr-1 ml-md-auto">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                    ...
                                    $f=[];
                                        foreach($chi as $k=> $v):?>
                                    <a class="dropdown-item" href="?v=home.php&jad=<?=$v['guruh']?>"><?=$v['guruh']?></a>
...
<?php endif ?>
            ...
            <div class="col-md-3 order-1 mb-5 mb-md-0">
                <div class="border p-4 rounded mb-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        ?>
                        <li class="mb-1"><a href="?v=home.php&jins=2" class="d-flex"><span>qizbolalar</span> <span class="text-black ml-auto"><?= $con2['son'] ?></span></a></li>
                        <li class="mb-1"><a href="?v=home.php&jins=1" class="d-flex"><span>o'gilbolalar</span> <span class="text-black ml-auto"><?= $con['son'] ?></span></a></li>
                    </ul>
                </div>
            ...
            <div class="col-12" >
                    <div class="col-md-12 text-center">
                                <ul class="pagination">
                                    <li class="page-item ">
                                        <a class="page-link bg-dark" href="?v=home.php&jins=<?= $_GET['jins'] ?>&k=<?= ($_GET['k']-1>0) ? $_GET['k']-1 :'' ?>">&lt;</a>
                                    </li>
                                    <?php
                                    ...
                                    ?>
                                            <li class="page-item">
                                            <a class="page-link <?= (isset($_GET['k'])&&$_GET['k']==$i) ? ' active' :'  bg-dark' ?>" href="?v=home.php&jins=<?= $_GET['jins'] ?>&k=<?= $i ?>"><?= $i ?></a>
                                        </li>
                            ...
                            <?php
                                  ...
                                  <li class="page-item">
                                        <a class="page-link bg-dark" href="?v=home.php&jins=<?= $_GET['jins'] ?>&k=<?= ($_GET['k']+1<$asd) ? $_GET['k']+1 :'' ?>">&gt;</a>
                                    </li>
                                </ul>
                        </div>
                    </div>
